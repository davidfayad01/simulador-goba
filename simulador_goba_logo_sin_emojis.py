...
st.write(f"Eficiencia ganada en días: **{savings_days} días ({cash_type})**")
st.write(f"Ahorro estimado en flujo de caja: **${cash_improvement:,.2f}**")
...
st.write(f"ROI estimado: **{roi * 100:.2f}%**")
